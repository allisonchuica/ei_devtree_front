        ...
        <>
            ...
            >
                <div className="grid grid-cols-1 space-y-3">
                    <label htmlFor="name" className="text-2xl text-slate-600">Nombre</label>
                    <input
                        id="name"
                        type="text"
                ...
                <div className="grid grid-cols-1 space-y-3">
                    <label htmlFor="handle" className="text-2xl text-slate-600">Handle</label>
                    <input
                        id="handle"
                        type="text"
                ...
                <div className="grid grid-cols-1 space-y-3">
                    <label htmlFor="password_confirmation" className="text-2xl text-slate-600 ">Repetir Password</label>
                    <input
